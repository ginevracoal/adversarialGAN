...
class Car_classic(Car):
    ...
    def update(self, dt, current_distance):
        ...
        super().update(classic_norm_e_torque, classic_norm_br_torque, dt)
...
class Environment(Environment):
    ...
    def __init__(self, device):
        self._leader_car = Car_classic(device)

    def update(self, parameters, dt):
        """ Updates the physical state with the parameters
            generated by the NN.
        """
        self._leader_car.update(dt=dt, current_distance=self._agent.distance)

class Agent(Agent):

    def __init__(self, device):
        self._car = Car_classic(device)

    def update(self, parameters, dt):
        """ Updates the physical state with the parameters
            generated by the NN.
        """
        self._car.update(dt=dt, current_distance=self.distance)
...
class Model_classic(Model):
    ...
    def step(self, env_input, agent_input, dt):
      ...
      self.environment.update(dt, dist)
      self.agent.update(dt, dist)
