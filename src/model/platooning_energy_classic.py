...
class Car_classic(Car):
    ...
    def __init__(self, device, reference_distance = torch.tensor(40.0), initial_distance = torch.tensor(40.0)):
...
if __name__ == "__main__":
    ...
    for i in range(journey_length):
        ...
        state_storage = np.append(state_storage, np.array([[follower.position.item(), \
                            follower.vel.item(),ref_vehicle_position, ref_vehicle_speed ]]), axis = 0)
