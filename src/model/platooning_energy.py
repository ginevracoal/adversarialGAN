...
class Car():
    ...
    def update(self, dt, norm_e_torque, norm_br_torque, dist_force=0):
        ...
        self.e_power = (self.e_motor_speed*self.e_torque).to(self.device)*effective_efficiency
        self.position += self.velocity * dt
        # print(self.e_motor_speed, self.e_torque, effective_efficiency)
        # print(self.e_power, self.position)
...
class Environment:
    ...
    def update(self, parameters, dt):
        ...
        e_torque = torch.tanh(e_torque)
        br_torque = torch.sigmoid(br_torque)
